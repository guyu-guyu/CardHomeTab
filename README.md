...
9. **Content styles cover Markdown content only.** Table zebra stripes deliberately skip the tables that `base` views and Dataview render, because those bring their own row markup and theme styling.
